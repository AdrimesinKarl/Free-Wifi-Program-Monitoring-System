...
{{-- Success Message --}}
@if(session('success'))
    <div class="mb-6 p-3 bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 text-green-700 dark:text-green-400 rounded-lg text-sm">
        {{ session('success') }}
    </div>
@endif
...
{{-- Error Message --}}
@error('csv_file')
    <div class="mb-6 p-3 bg-red-50 dark:bg-red-950 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-400 rounded-lg text-sm">
        {{ $message }}
    </div>
@enderror
